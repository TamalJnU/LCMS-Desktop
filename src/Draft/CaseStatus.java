 ...
 * @author B3
 */
public class CaseStatus extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox3.setBackground(new java.awt.Color(167, 190, 174));
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pending", "Investigating", "Solved", "On Trial", "Closed", "Verdicted" }));

        jDateChooser4.setBackground(new java.awt.Color(167, 190, 174));

        jLabel21.setText("Case Status");

        jLabel22.setText("Next Court Date");
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        IFCaseStatus caseStatus = new IFCaseStatus();
        jPanel1.removeAll();
        jPanel1.add(caseStatus).setVisible(true);
