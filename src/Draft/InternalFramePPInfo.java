 ...
 * @author Tamal
 */
public class InternalFramePPInfo extends javax.swing.JInternalFrame {

    /**
     * Creates new form NewJInternalFrame1
     */
    public InternalFramePPInfo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Add New PP");

        jButton2.setText("PP Information");

        jButton3.setText("Edit/Update PP");

        jButton4.setText("Assigned Case");

        jButton5.setText("Case Status");

        jButton7.setText("Hearing Dates");

        jPanel1.setBackground(new java.awt.Color(231, 232, 209));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Attorney List");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PP Id", "PP Name", "Court No", "Court Id", "Court Name", "Court Type", "Court City"
            }
        ));
